...
public class CommentController {
    ...
    public ResponseEntity<CommentResponse> getAllCommentsByPost(
        ...
        CommentResponse commentResponse = commentService.getAllCommentsByPost(postId, pageNumber, pageSize, sortBy, sortDir);
    ...
    public ResponseEntity<CommentResponse> getAllCommentsByUser(
        ...
        CommentResponse commentResponse = commentService.getAllCommentsByUser(userId, pageNumber, pageSize, sortBy, sortDir);
        return ResponseEntity.ok(commentResponse);
    }
}
