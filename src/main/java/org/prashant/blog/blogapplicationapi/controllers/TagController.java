...
public class TagController {
    ...
    @PostMapping("/create/")
    public ResponseEntity<TagDto> createTagHandler(@RequestBody CreateTagRequest createTagRequest){
        TagDto created_tag = tagService.createTag(createTagRequest);
        return new ResponseEntity<>(created_tag,HttpStatus.CREATED);
    }
